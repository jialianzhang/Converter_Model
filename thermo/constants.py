...
OXIDATION_THERMO = {
    ...
    'Si':  {'n': 2,   'A': 30110.0,  'B': -11.40, 'delta_H':  580000.0},
    'Mn':  {'n': 1,   'A': 12760.0,  'B': -5.68,  'delta_H':  280000.0},
    'P':   {'n': 2.5, 'A': 18355.0,  'B': -14.53, 'delta_H':  750000.0},
    'V':   {'n': 1.5, 'A': -17800.0, 'B':  8.21,  'delta_H':  450000.0},
    'Ti':  {'n': 2,   'A': -32200.0, 'B': 12.86,  'delta_H':  680000.0},
    'Fe':  {'n': 1,   'A':  6320.0,  'B': -2.73,  'delta_H':  120000.0},
}
